<template>
   <div class="group relative p-0.5 rounded-xl border-white duration-500
    hover:bg-red-100/40">
        <div>
            <!-- 搜索小图标 -->
            <m-svg-icon 
            ...
            <!-- 输入框 -->
            <input class=" block w-full h-[22px] pl-4 outline-0 
            ...
            <div class=" opacity-0 h-1.5 w-[1px] absolute translate-y-[-50%] top-[50%]
             ...
             <!--  搜索按钮(通用组件) -->
             <m-button class="absolute translate-y-[-50%] top-[50%] right-3" icon="search" iconColor="#fff"></m-button>
        </div>
        <!-- 下拉区 -->
        <transition name="slide">
            <div class=" max-h-[368px] w-full text-base overflow-auto bg-white
