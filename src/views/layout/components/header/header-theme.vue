  ...
  <m-popover placement="bottom-left">
    ...
    <template #reference>
        <m-svg-icon :name="svgIconName" 
         class="dark:hover:bg-zinc-900 w-4 h-4 p-1 cursor-pointer rounded-sm duration-200 outline-none
    ...
    <div class=" w-[50px] overflow-hidden">
      ...
      >
         ...
         <span
          class="text-zinc-800 text-sm dark:text-zinc-300"
          >{{ item.name }}</span>
      </div>
    </div>
  </m-popover>
...
//3.根据vuex中保存的当前主题,展示header-theme下的图标
