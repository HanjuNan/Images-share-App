<template>
  <div
    class=" duration-500 bg-white dark:bg-zinc-800 duration-500 sticky top-0 left-0 w-full z-10"
  >
    <ul
      class="w-[400px] relative flex flex-wrap justify-center overflow-x-auto px-[10px] py-1 text-xs text-zinc-600 duration-300 overflow-hidden mx-auto"
      :class="[isOpenCategoty ? 'h-[103px]' : 'h-[28px]']"
    >
      <!-- lg 下展开箭头 -->
      <div
